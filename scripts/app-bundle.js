...
define('singletons/config',["require", "exports", "../entities/galleryObject", "../entities/galleryGroup", "../components/iconRow"], function (require, exports, galleryObject_1, galleryGroup_1, iconRow_1) {
    ...
    var Config = (function () {
        function Config() {
            ...
            this.iconList = [
                new iconRow_1.IconRow("#", "deviantart", "Art, WIPs, commissions, adoptables, and more! All art hubb."),
                new iconRow_1.IconRow("#", "twitch", "Art streams on Saturdays, video game streams on Sundays, Tuesdays, and Thursdays. Come chat with me and ask me anything!"),
                new iconRow_1.IconRow("#", "youtube", "Stream highlights, speedpaints, tutorials, Q&A's, and more!"),
                new iconRow_1.IconRow("#", "wordpress", "Blog posts of game reviews, philosophy, art, everything and The Kitchen Sink!"),
                new iconRow_1.IconRow("#", "tumblr", "Art, WIPs, Q&A's, and more!"),
                new iconRow_1.IconRow("#", "twitter", "Bite-sized posts of my art and gaming life, along with the occasional cat.")
            ];
